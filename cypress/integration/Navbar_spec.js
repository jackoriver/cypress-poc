...
describe('Test the navbar', () => {
  ...
  it.only('Verify the Page Header is present', () => {
    cy
      ...
      .should('be.visible')
    cy
      .get('#masthead .site-branding .beta.site-title')
      .should('be.visible')
      .and('have.text', 'Testing Playground')
    cy
      .get('#masthead .site-branding .site-description')
      .should('be.visible')
    ...
    cy
      ...
      .should('be.visible')
    cy
      .get('#menu-custom-menu')
      .should('be.visible')
    cy
      .get('#menu-custom-menu > li')
      .should('have.length', 3)
    cy
      .get('#site-header-cart span.woocommerce-Price-amount')
      .should('be.visible')
    cy
      .get('#site-header-cart span.count')
      .should('be.visible')
  })
